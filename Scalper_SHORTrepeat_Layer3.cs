...
// scalper_SHORTrepeat_Layer3  v3  (reconnect-survival + file-per-session + EOD)
//
// ============================================================================
...
namespace NinjaTrader.NinjaScript.Strategies
{
    ...
    public class scalper_SHORTrepeat_Layer3 : Strategy
    {
        ...
        private void CheckFakeSlice()
        {
            try
            {
                ...
                if (wasMoneySlice)
                {
                    ...
                    {
                        // Money already recorded by OnExecutionUpdate. Still record the PATTERN bit
                        // here from the data feed (cross-line), every slice (like a Renko brick).
            ...
            string orderId, DateTime time)
        {
            ...
            // vote, unknown -> loss. Tie/loss-majority -> 0. Writes ONLY the money string, never rawString.
                    ...
                    && (Position.MarketPosition != MarketPosition.Flat || HasLiveOrders()))
                {
                    ...
                    else
                    {
                        ...
                        DiagLog("[SHUTDOWN][FLATTEN FAILED] not flat & order-free after " + MaxFlattenAttempts
                            + " passes -> STOPPING. CHECK ACCOUNT AND FLATTEN BY HAND.");
                    }
                }
