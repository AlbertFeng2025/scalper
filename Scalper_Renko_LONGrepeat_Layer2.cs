...
// Scalper_Renko_LONGrepeat_Layer2  v1
//
// ============================================================================
// WHAT THIS IS
// ============================================================================
// A Renko-based Layer-2 meta-labeling strategy for LONG on MNQ.
// (Direction mirror of Scalper_Renko_SHORTrepeat_Layer2 — same pipeline, flipped
...
{
    public class Scalper_Renko_LONGrepeat_Layer2 : Strategy
    {
        // ── strategy lifecycle ────────────────────────────────────────────────
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                Name        = "Scalper_Renko_LONGrepeat_Layer2";
                ...
                LogFolder            = @"C:\temp";
                LogBaseName          = "scalper_Renko_LONGrepeat_Layer2";
